...
func TestProduceRequestV2(t *testing.T) {
	...
	header.values = append(header.values, "myheader")
	header.values = append(header.values, []byte("myheadervalue"))
	headerArr := make([]interface{}, 0)
	...
	message1.values = append(message1.values, []byte{0})
	message1.values = append(message1.values, []byte{1})
	message1.values = append(message1.values, headerArr)
	...
	message2.values = append(message2.values, []byte{1})
	message2.values = append(message2.values, []byte{2})
	message2.values = append(message2.values, headerArr)
	...
	recordArr := make([]interface{}, 0)
	recordArr = append(recordArr, &message1)
	recordArr = append(recordArr, &message2)

	recordBatch.values = append(recordBatch.values, int64(0))
	recordBatch.values = append(recordBatch.values, int32(0))
	recordBatch.values = append(recordBatch.values, int32(0))
	recordBatch.values = append(recordBatch.values, int8(0))
	recordBatch.values = append(recordBatch.values, int32(0))
	recordBatch.values = append(recordBatch.values, int16(0))
	recordBatch.values = append(recordBatch.values, int32(0))
	recordBatch.values = append(recordBatch.values, int64(0))
	recordBatch.values = append(recordBatch.values, int64(0))
	recordBatch.values = append(recordBatch.values, int64(0))
	recordBatch.values = append(recordBatch.values, int16(0))
	recordBatch.values = append(recordBatch.values, int32(0))
	recordBatch.values = append(recordBatch.values, recordArr)
	...
	topics := []string{"topic1", "topic2"}
	en, err := EncodeSchema(&recordBatch, recordBatchSchema)

	partitionData.values = append(partitionData.values, int32(0))
	partitionData.values = append(partitionData.values, int32(len(en)))
	partitionData.values = append(partitionData.values, &recordBatch)
...
func TestProduceRequestV3(t *testing.T) {
	...
	schemaProduce := NewSchemaStruct("produce_v3",
		...
		&field{name: "correlation_id", ty: typeInt32},
		&field{name: "client_id", ty: typeStr},
		&field{name: "transactional_id", ty: typeNullableStr},
		&field{name: "required_acks", ty: typeInt16},
		&field{name: "timeout", ty: typeInt32},
		&array{name: "topics", ty: topicSchema},
	)
	...
	produceData.values = append(produceData.values, int32(0))
	produceData.values = append(produceData.values, "custom")
	produceData.values = append(produceData.values, &transactId)
	produceData.values = append(produceData.values, int16(0))
	produceData.values = append(produceData.values, int32(0))
	arr := make([]interface{}, 0)
	arr = append(arr, &topicData1)
